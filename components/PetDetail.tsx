    ...
    <div className="bg-white dark:bg-[#1a1a1a] h-screen flex flex-col overflow-hidden relative">
      ...
      <div className="flex-1 overflow-y-auto hide-scrollbar">
        <div className="relative h-[55vh] group overflow-hidden">
          <button onClick={onBack} className={`absolute top-12 ${lang === 'ar' ? 'right-5 rotate-180' : 'left-5'} p-3 rounded-2xl bg-white/20 backdrop-blur-md text-white border border-white/20 active:scale-90 shadow-xl transition-all z-[60]`}>
            <ArrowLeft size={24} />
          </button>

          <div className={`absolute top-12 ${lang === 'ar' ? 'left-5' : 'right-5'} z-[60]`}>
            {showMenu && (
